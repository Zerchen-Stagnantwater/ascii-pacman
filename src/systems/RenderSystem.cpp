...
sf::String RenderSystem::getWallChar(const Map& map, int r, int c) const {
    ...
    switch (mask) {
        case 0b1111: return sf::String(L"\u256C");
        case 0b1110: return sf::String(L"\u2563");
        case 0b1101: return sf::String(L"\u2560");
        case 0b1011: return sf::String(L"\u2569");
        case 0b0111: return sf::String(L"\u2566");
        case 0b1100: return sf::String(L"\u2551");
        case 0b0011: return sf::String(L"\u2550");
        case 0b1001: return sf::String(L"\u255D");
        case 0b1010: return sf::String(L"\u255A");
        case 0b0101: return sf::String(L"\u2557");
        case 0b0110: return sf::String(L"\u2554");
        case 0b1000: return sf::String(L"\u2551");
        case 0b0100: return sf::String(L"\u2551");
        case 0b0010: return sf::String(L"\u2550");
        case 0b0001: return sf::String(L"\u2550");
        default:     return sf::String(L"\u25A0");
    }
}
...
void RenderSystem::drawMap(const Map& map) {
    for (int r = 0; r < Map::ROWS; r++) {
        for (int c = 0; c < Map::COLS; c++) {
            if (map.getCell(r, c) != Cell::Wall) continue;
            sf::Text t(font, getWallChar(map, r, c), Config::CELL_SIZE - 2);
            t.setFillColor(sf::Color(0, 100, 255));
            t.setPosition(sf::Vector2f(c * Config::CELL_SIZE, r * Config::CELL_SIZE + 40));
            window.draw(t);
        }
    }
}
...
void RenderSystem::drawEntities(entt::registry& registry) {
    ...
    for (auto [entity, pos, render] : view.each()) {
        ...
        t.setPosition(sf::Vector2f(pos.col * Config::CELL_SIZE, pos.row * Config::CELL_SIZE + 40));
        window.draw(t);
    }
}

void RenderSystem::drawHUD(int score, int lives, bool powered) {
    std::string hud = "Score: " + std::to_string(score) + "   Lives: " + std::to_string(lives);
    if (powered) hud += "  [POWERED]";
    sf::Text t(font, hud, 16);
    t.setFillColor(sf::Color::White);
    t.setPosition(sf::Vector2f(4, 4));
    window.draw(t);
}
